...
const Masonry: React.FC<MasonryProps> = ({
  ...
  // Adjust container height to fit the tallest column so that elements below layout naturally
  ...
  return (
    <div ref={containerRef} className="list" style={{ height: containerHeight ? `${containerHeight}px` : 'auto' }}>
      {grid.map(item => {
        return (
          <div
            key={item.id}
