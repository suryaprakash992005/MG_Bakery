        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-[#2A0E0A]/60 font-medium tracking-wide">
              Login to view your premium bakery order history & details
            </p>
          </div>
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-rose-50 border border-rose-100 text-rose-800 rounded-xl p-3.5 mb-5 text-xs flex items-start gap-2.5"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-[#FAF7F2]/40 rounded-xl border border-brand-cream-200 text-sm text-[#2A0E0A] placeholder-[#2A0E0A]/30 focus:outline-none focus:ring-2 focus:ring-[#C9A227]/30 focus:border-[#C9A227] transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-3 bg-[#FAF7F2]/40 rounded-xl border border-brand-cream-200 text-sm text-[#2A0E0A] placeholder-[#2A0E0A]/30 focus:outline-none focus:ring-2 focus:ring-[#C9A227]/30 focus:border-[#C9A227] transition-all"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#2A0E0A] hover:bg-[#1f0a07] text-white font-semibold rounded-xl text-sm shadow-md shadow-[#2A0E0A]/10 active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
          ...
          <div className="mt-8 text-center border-t border-brand-cream-100/50 pt-6">
            <p className="text-xs text-[#2A0E0A]/60">
              Don't have an account?{' '}
              <Link to="/signup" className="text-brand-gold-700 hover:text-brand-gold-800 font-bold transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
