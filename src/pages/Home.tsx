...
import { ArrowRight, Sparkles, ShieldCheck, Heart, Users, Compass, Zap, LayoutGrid, Layers, Star, MapPin } from 'lucide-react';
...
import BakeryOvenHero from '../components/BakeryOvenHero';
...
export const Home: React.FC<HomeProps> = ({ setCurrentPage }) => {
  ...
  // Rotate customer reviews slide automatically every 6 seconds
  useEffect(() => {
  ...
  return (
    <div className="pt-0 snap-y-container">
      {/* 1. Interactive 3D Bakery Oven Hero Section */}
      <BakeryOvenHero setCurrentPage={setCurrentPage} />
